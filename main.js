...
const searchButton = document.getElementById('search-button'),
      searcgClose = document.getElementById('search-close'),
...
/* SEARCH HIDDEN */
if(searcgClose){
    searcgClose.addEventListener('click', () =>{
...
const shoppingButton = document.getElementById('shopping-button'),
      shoppingClose = document.getElementById('shopping-close'),
      ShoppingContent = document.getElementById('shopping-content')

/* SEARCH SHOW */
if(shoppingButton){
    shoppingButton.addEventListener('click', () =>{
        loginContent.classList.add('show-shopping')
    })
}
...
if(shoppingClose){
    shoppingClose.addEventListener('click', () =>{
        ShoppingContent.classList.remove('show-shopping')
    })
}
...
function fadeOut() {
    setTimeout(() => {
        ...
        if (loader) {
            loader.style.display = "none"; // Hides loader completely
        }
